...
Output requested code changes and new code in the unified "git diff" syntax.
...
- LINES TO BE REMOVED (starting with single -) AND LINES TO BE RETAINED (no starting symbol) HAVE TO REPLICATE THE DIFFED HUNK OF THE CODE EXACTLY LINE BY LINE. KEEP THE NUMBER OF RETAIN LINES SMALL IF POSSIBLE.
